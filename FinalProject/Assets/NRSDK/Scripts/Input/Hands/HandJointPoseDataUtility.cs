namespace NRKernal
{
    ...
    internal class HandJointsArrayData
    {
        ...
        #region HandJointsArrayData_Right_Stop JSON
        public static string HandJointsArrayData_Right_Stop_Json = @"
        {
            ""jointInfoArray"": [
                {
                    ""jointID"": 3,
        ...
        #region HandJointsArrayData_Right_Pause JSON
        public static string HandJointsArrayData_HandJointsArrayData_Right_Pause_Json = @"
        {
            ""jointInfoArray"": [
                {
                    ""jointID"": 0,
